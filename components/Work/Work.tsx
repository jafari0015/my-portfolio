        ...
        {paginatedWorks.map((work) => (
          ...
          >
            <SpotLightCard className="p-6">
              <div>
                <div className="relative w-full h-[150px] sm:h-[220px] md:h-[250px] lg:h-[150px] xl:h-[180px]">
                  <a
                    href={work.github}
                    target="_blank"
                ...
                <h2 className="dark:text-stone-100 text-stone-900 text-xl md:text-2xl font-semibold mt-4">
                  {work.title}
                </h2>

                <p className="dark:text-stone-100 text-stone-900 md:text-medium  text-xs  mt-2 line-clamp-2">
                ...
                <div className="flex items-center relative justify-start gap-2 mt-3 dark:text-indigo-50 font-semibold">
                  ...
                  <div className="absolute -right-3 -bottom-3">
                    <Link href={`/work/${work.slug.current}`}>
                      <button className="px-3 cursor-pointer py-2 dark:bg-[#c8f31d] text-xs md:text-sm  dark:text-stone-950 bg-green-700 text-white rounded-md">
                        View Details
                      </button>
                    </Link>
                  </div>
